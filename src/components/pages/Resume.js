...
const Resume = () => {
  return (
    <div className="resume">
      ...
      <div className="resume-download"><a href={resume}>Download My Resume</a></div>
      <div className="resume-wrapper">
        <div className="resume-header">
          <div className="resume-header-left">
            <img src={image} alt="Van Tabbert" className="resume-img" height="200px" width="200px"/>
          </div>
        ...
        <div className="resume-body">
          <div className="resume-body-left">
            ...
            <div className="resume-section">
              ...
              <div className="resume-contact-group-top">
                ...
                <div className="resume-text">
                  w: <a className="resume-link" href="https://www.vannya.me">www.vannya.me</a>
                </div>
              </div>
              <div className="resume-contact-group">
                <div className="resume-text">
                  <i className="fab fa-facebook" />{" "}
                  <a className="resume-link" href="https://www.facebook.com/vannienicole">
                    facebook.com/vannienicole
                  </a>
                </div>
                <div className="resume-text">
                  <i className="fab fa-github" />{" "}
                  <a className="resume-link" href="https://github.com/vannya">github.com/vannya</a>
                </div>
                <div className="resume-text">
                  <i className="fab fa-linkedin" />{" "}
                  <a className="resume-link" href="https://www.linkedin.com/in/vannya/">
            ...
            <div className="resume-section">
              ...
              <div className="resume-subheader-underline"></div>
                <div className="resume-text bottom-space">
                  <strong>Strong:</strong> ReactJS, JavaScript, HTML5, CSS3, ES6, Express, Sass,
                Git/Version Control, Photoshop, InDesign.
                </div>
                <div className="resume-text">
                  <strong>Knowledgable:</strong> Redux, MongoDB, Node.js, SQL, Webpack, Java, C++
                </div>
            </div>
            <div className="resume-section">
            ...
            <div className="resume-section">
              ...
              <div className="resume-subheader-underline"></div>
              <div className="resume-group">
                <div className="resume-text resume-title">Chingu Cohorts</div>
                <div className="resume-text resume-date">Jul 2017 - present</div>
                <div className="resume-text">
              ...
              <div className="resume-group">
                ...
                <div className="resume-text resume-date">Aug 2014 - Oct 2017</div>
          ...
          <div className="resume-body-right">
            <div className="resume-section bottom-space">
              <div className="resume-subheader">WORK EXPERIENCE</div>
              <div className="resume-subheader-underline"></div>
              <div className="resume-group">
                  <div className="resume-text resume-position">Accounting Specialist</div>
                  <div className="resume-text resume-location">Sound Productions - Irving, TX</div>
                  <div className="resume-text resume-date">Dec 2016 - Sept 2017</div>
                  <ul>
                    <li>Designed new system for 3-way matching for increased department efficiency. </li>
                    <li>Implemented process for shipment tracking for increased customer satisfaction.</li>
                    <li>Processed 8 months of backlogged financial documents within 60 days for 2017 year end reporting.
                    </li>
                  </ul>
              </div>
              <div className="resume-group">
                  <div className="resume-text resume-position">Guest Educator</div>
                  <div className="resume-text resume-location">Irving ISD - Irving, TX</div>
                  <div className="resume-text resume-date">Sept 2016 - Jun 2017</div>
                  <ul>
                    <li>Taught a range of grade levels and subjects as district needs fluctuated. </li>
                    <li>Preferred Guest Educator for gifted education and STEM classrooms in the district.</li>
                  </ul>
              </div>
              <div className="resume-group">
                  <div className="resume-text resume-position">Shift Supervisor</div>
                  <div className="resume-text resume-location">CVS Pharmacy - Irving, TX</div>
                  <div className="resume-text resume-date">May 2012 - Nov 2013</div>
                  <ul>
                    <li>Lead supervisor for 24-hour store with responsibility for 6 cashiers and technicians.</li>
                    <li>Decreased shrink/loss in both Makeup and Beauty departments by 5% and 7%. </li>
                    <li>Led bi-weekly inventory counts to maintain streamlined product flow.</li>
                  </ul>
              </div>
            </div>
            <div className="resume-section bottom-space">
              <div className="resume-subheader">SIDE PROJECTS</div>
              <div className="resume-subheader-underline"></div>
            ...
            <div className="resume-education">
              ...
              <div className="resume-subheader-underline"></div>
              <div className="resume-group">
                  <div className="resume-text resume-title">Associates of Applied Science, Software Development</div>
                  <div className="resume-text resume-title">North Lake College - Irving, TX</div>
              ...
              <div className="resume-group">
                  <div className="resume-text resume-title">Associates of Arts, Liberal Studies</div>
                  <div className="resume-text resume-title">North Lake College - Irving, TX</div>
